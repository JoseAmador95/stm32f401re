...
# set(OBJECT_GEN_FLAGS "-O0 -mthumb -fno-builtin -Wall -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -mfloat-abi=hard -MMD -MP")
...
add_compile_options(
    ...
    $<$<CONFIG:Debug>:-g3>
    $<$<AND:$<CONFIG:Debug>,$<NOT:$<COMPILE_LANGUAGE:ASM>>>:-gdwarf-2> 
    $<$<AND:$<CONFIG:Debug>,$<NOT:$<COMPILE_LANGUAGE:ASM>>>:-O0> 
    $<$<CONFIG:Release>:-flto>
    $<$<AND:$<CONFIG:Release>,$<NOT:$<COMPILE_LANGUAGE:ASM>>>:-Os> 
)
